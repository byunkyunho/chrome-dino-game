...
image_load_list = [["walk_1","걷기 1", (80, 80)], ["walk_2","걷기 2", (80, 80)], ["cloud_image", "구름",(120, 36)], ["dino_image", "dino", (80,80)], ["obstacle_1", "선인장_2", (120, 100)], ["obstacle_2", "선인장_3", (90, 90)], ["obstacle_3", "선인장_4", (50, 100)], ["obstacle_4", "선인장_5", (130, 86)], ["t_gameover", "게임오버_글자", (480,30)], ["gameover_image", "게임오버 다시하기", (88, 80)], ["die_image", "다이노 죽음" ,(80, 80)], ["hi_score", "하이스코어", (33, 18)]]
...
num_list = []
for a in range(10):
    num_list.append(pg.transform.scale(pg.image.load("image/{}.png".format(a)),(15, 18)))
...
def game_set():
    global walk_image, dino_x, dino_y, walk_image2, add_cloud, cloud_list, add_dust, dust_list, game_speed , speed_up,  jump, jump_speed, add_obstacle, obstacle_list, die, score, plus_score
    walk_image = 0
    dino_x = 50
    dino_y = 380
    walk_image2 = 0
...
def check_collision():
    for obstacle in obstacle_list:
        if dino_x + 80 > obstacle[1][0] and dino_x + 80 < obstacle[1][0] + obstacle[2][1][0] and dino_y + 80 > obstacle[1][1] and dino_y + 80 < obstacle[1][1] + obstacle[2][1][1]:
            return True
...
def d_score():
    global sparkle_score
    screen.blit(hi_score, (710, 15))
    num = best_score
    for a in range(5):
        screen.blit(num_list[num//10**(4-a)], (770 + a*19, 15))
        num = num % 10**(4-a)
    num = score
    for a in range(5):
        screen.blit(num_list[num//10**(4-a )], (880 + a*19, 15))
        num = num % 10**(4-a)
